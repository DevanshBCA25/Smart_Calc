# 🧮SmartCalc LLM – AI MathBoard Assistant
...
✅ Matrix Operations – Compute transpose, rank, determinant, inverse, and eigenvalues.
✅ Interactive Whiteboard – Write or draw equations directly in the app.
...
Whiteboard Drawing: streamlit-drawable-canvas
...
Computation: SymPy safely computes or simplifies the expression.

AI Assistance: OpenAI GPT provides an explanation of each step (if enabled).
...
Voice-based math input.

AI-generated visual step diagrams.
